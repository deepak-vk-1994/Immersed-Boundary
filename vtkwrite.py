...
def writevtk_structured_2D(grid, gridsize, data, filename, comment=None):
...
def translate_fortran_to_vtk(gridfile, datafile, opfilename, filecomment):
    ...
    writevtk_structured_2D(grid, gridsize, data, opfilename, filecomment)
